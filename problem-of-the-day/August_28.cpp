...
int main() {
    ...
    string s2 = "abc";
    string target2 = "cba";
    string result2 = solution.lexPalindromicPermutation(s2, target2);
    cout << "Lexicographically Smallest Palindromic Permutation Greater Than Target: " << result2 << endl;

    string s3 = "aabbcc";
    string target3 = "abcabc";
    string result3 = solution.lexPalindromicPermutation(s3, target3);
    cout << "Lexicographically Smallest Palindromic Permutation Greater Than Target: " << result3 << endl;
